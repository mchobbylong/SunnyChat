...
public class ClientSeeGroupMember extends JFrame implements ActionListener {
	...
	public ClientSeeGroupMember() {
		...
		// member list
		memberList = new JPanel(new BorderLayout());
		String[] noClientsYet = {"No member now."};
		setClientPanel(noClientsYet);
		memberList.setBounds(20, 65, 460, 220);
		c.add(memberList);
...
/*        if(currClients.length > 1){
        ...
        memberList.add(clientPanel, BorderLayout.CENTER);
    }
}
